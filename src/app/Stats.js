...
export default class Stats extends React.Component {
  ...
  render() {
    const progress = this.progress(
      this.props.data.update.index,
      this.props.data.update.prompt.length
    );
    return (
      <div id="statsbox">
        <Row>
              ...
              <p>
                ...
                <span id="wpm">
                  {this.wordPerMinute(
                    ...
                    this.props.data.statUpdater.correctKey,
                    this.props.data.update.index
                  )}
                </span>
              </p>
              <p data-testid="efficiencyid">
                Efficiency:{" "}
                <span id="eff">
                  {this.efficiency(
                    this.props.data.statUpdater.keyCounter,
                    this.props.data.statUpdater.correctKey
                  )}
                </span>
                %
